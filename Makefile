...
DHDCFLAGS = -Wall -Wstrict-prototypes -Dlinux -DBCMDRIVER                 \
	...
	-DWL_EXT_IAPSTA -DSUPPORT_P2P_GO_PS -DWL_SCHED_SCAN                   \
...
#myadd obj-$(CONFIG_AP6XXX) += bcmdhd.o
#myadd bcmdhd-objs += $(DHDOFILES)
...
#add add
#myadd
EXTRA_CFLAGS += -fno-inline -fno-omit-frame-pointer
#myadd end
